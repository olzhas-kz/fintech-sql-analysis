...
All analysis was done in sql server using ssms. The results were visualized in power bi. No python, no excel, just sql and power bi from start to finish.
...
> see: **revenue по годам и месяцам** chart in the dashboard
...
> see: **топ категорий по revenue** chart in the dashboard
...
> see: **заказы по штатам** chart in the dashboard
...
> see: **способы оплаты** chart in the dashboard
...
**dashboard.pbix** — power bi dashboard visualising the sql analysis results. [download from google drive](https://drive.google.com/file/d/1Bjf5JoepIeK__wFZMET5atWlgUkhdAVO/view?usp=sharing)
